...
return [
    ...
    */
    ...
    "gt" => [
        ...
        "array"   => ":attribute 必须有超过 :value 元素.",
    ],
    ...
    */
    ...
    "mobile" => ":attribute 必须是一个有效的电话号码",
    "id_card" => ":attribute 必须是一个有效的证件号码",
    "custom_email" => ":attribute 必须是一个合法的电子邮件地址",

    "address_required_if" => ":attribute 字段是必须的当 :other 是 中国",

    "register_required_without" => ":attribute或:values至少存在一个",
];
